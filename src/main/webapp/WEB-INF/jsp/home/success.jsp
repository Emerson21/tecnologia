    ...
    <div class="container">
		...
		<form id="form-contato" action="<c:url value="/contato"/>" class="form-horizontal" role="search" method="post">
			<div class="form-group input-group">
		  		...
		  		<input id="to" type="text" class="form-control" name="email.to" placeholder="Digite seu e-mail">
			</div>
			<div class="form-group input-group">
		  		<span class="input-group-addon">Assunto</span>
		  		<input id="subject" type="text" class="form-control" name="email.subject" placeholder="Orçamento, Contratação de serviços">
			</div>
			<textarea id="message" placeholder="Digite sua mensagem aqui" class="form-control form-group" name="email.message" rows="3"></textarea>
